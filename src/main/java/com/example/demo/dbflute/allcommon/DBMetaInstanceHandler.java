...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("cart", "com.example.demo.dbflute.bsentity.dbmeta.CartDbm");
        tmpMap.put("orders", "com.example.demo.dbflute.bsentity.dbmeta.OrdersDbm");
        tmpMap.put("product", "com.example.demo.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("stock", "com.example.demo.dbflute.bsentity.dbmeta.StockDbm");
        tmpMap.put("user", "com.example.demo.dbflute.bsentity.dbmeta.UserDbm");
